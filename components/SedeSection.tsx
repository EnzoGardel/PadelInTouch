    ...
    <section id="ubicaciones" className="py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-white/20 p-10 rounded-3xl shadow-md">
        ...
        {/* Centro */}
          ...
          <Card className="group relative overflow-hidden border-0 bg-white/90 rounded-2xl transition duration-300 hover:-translate-y-2 hover:shadow-2xl hover:ring-2 hover:ring-primary/20">
            ...
            <CardContent className="p-6 flex flex-col flex-grow relative z-10">
              ...
              <div className="space-y-3 text-slate-600 flex-grow">
                <div className="flex items-start space-x-2">
                  <MapPin className="h-5 w-5 text-primary mt-0.5 flex-shrink-0 transition-transform duration-300 group-hover:scale-125" />
                  <span>San Nicolás 965. Rosario, Santa Fe</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Phone className="h-5 w-5 text-primary transition-transform duration-300 group-hover:scale-125" />
                  <span>341-5761895</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Clock className="h-5 w-5 text-primary transition-transform duration-300 group-hover:scale-125" />
      ...
      {/* Lavalle */}
          ...
          <Card className="group relative overflow-hidden h-full flex flex-col border-0 bg-white/90 rounded-2xl transition duration-300 hover:-translate-y-2 hover:shadow-2xl hover:ring-2 hover:ring-primary/20">
            <div className="relative h-48 md:h-52 w-full overflow-hidden">
              <img
       ...
       {/* Abasto */}
          <Card className="group relative overflow-hidden h-full flex flex-col rounded-2xl border-0 bg-white/90 transition duration-300 hover:-translate-y-2 hover:shadow-2xl hover:ring-2 hover:ring-primary/20">
            <div className="relative h-48 md:h-52 w-full overflow-hidden">
              <img
